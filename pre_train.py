...
def XY():
    X,Y=[],[]
    with open('D:/Python/PycharmProject/-bot-master/data/financezhidao_filter2.csv', encoding='gbk', errors='ignore') as csvfile:
...
def word_segment2(X, Y):
    output_x = open('D:/Python/PycharmProject/-bot-master/data/X.txt', 'r', encoding='utf-8')
    output_y = open('D:/Python/PycharmProject/-bot-master/data/Y.txt', 'r', encoding='utf-8')
